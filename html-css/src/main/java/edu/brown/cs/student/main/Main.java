...
public final class Main {
  ...
  private static class AutocorrectHandler implements TemplateViewRoute {
    public ModelAndView handle(Request req, Response res){
      Map<String, String> variables = ImmutableMap.of("title", "Front End Lab Cs32", "message", "Hi the body function is working!", "suggestions","");
   ...
   *  (autocorrect.ftl).
   */
  public static class SubmitHandler implements TemplateViewRoute{
    public ModelAndView handle(Request req, Response res){
      QueryParamsMap qm = req.queryMap();
      String textFromTextField = qm.value("text");
      Set<String> set = ac.suggest(textFromTextField);
      String suggestion = set.toString();
      Map<String, String> variables = ImmutableMap.of("suggestions",suggestion,"title"," the title","message","The message goes here!");
      return new ModelAndView(variables,"autocorrect.ftl");
    }
  }
}
